...
or increase socketAcquisitionWarningTimeout=(millis) in the NodeHttpHandler config.`);
  ...
  resolveDefaultConfig(options) {
    const { requestTimeout: requestTimeout2, connectionTimeout, socketTimeout, socketAcquisitionWarningTimeout, httpAgent, httpsAgent, throwOnRequestTimeout, logger: logger2 } = options || {};
  ...
  async handle(request, { abortSignal, requestTimeout: requestTimeout2 } = {}) {
    ...
    return new Promise((_resolve, _reject) => {
      ...
      const effectiveRequestTimeout = requestTimeout2 ?? config.requestTimeout;
...
var HttpProtocol = class extends SerdeContext {
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./event-streams-RL5WOQSB.js");
...
//# sourceMappingURL=chunk-OCN2U2HI.js.map
