...
import {
  ...
  resolveParams
} from "./chunk-P7MYJZHN.js";
import {
  loadConfig,
  parseUrl
} from "./chunk-S7DBSN5V.js";
import {
  Client,
  Command,
  NoOpLogger,
...
var remoteProvider = async (init) => {
  const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./dist-es-CFA6JV5X.js");
...
`);
  ...
  async (awsIdentityProperties) => {
    ...
    const { fromIni } = await import("./dist-es-IM2Z5LNB.js");
    return fromIni(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
    const { fromProcess } = await import("./dist-es-HD3TOJ7V.js");
    return fromProcess(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
    const { fromTokenFile } = await import("./dist-es-3SPF3BYY.js");
