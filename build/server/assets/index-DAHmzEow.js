import { P as ProviderError, I as IniSectionType, i as CONFIG_PREFIX_SEPARATOR, r as readFile, j as getConfigFilepath, k as parseIni, d as getProfileName, C as CredentialsProviderError } from "./SignatureV4MultiRegion-B05s6TWe.js";
import { f as fs } from "./server-build-Bwh1Gzls.js";
import { g as getSSOTokenFilepath, a as getSSOTokenFromFile } from "./getSSOTokenFromFile-BB6pa-Ja.js";
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
  const { SSOOIDCClient } = await import("./index-vSYzxDzv.js");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
  const { CreateTokenCommand } = await import("./index-vSYzxDzv.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-Dhw0H2Mc.js");
