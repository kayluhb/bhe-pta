        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 text-center border-t-4 border-spirit-gold">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-spirit-gold text-night-blue font-heading font-bold px-8 py-3 rounded-full hover:bg-spirit-gold/90 transition-all duration-200 hover:shadow-lg hover:shadow-spirit-gold/25 shrink-0"
              >
                Subscribe
              </button>
            </form>
