      ...
      <section className="bg-warm-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mt-8 text-lg md:text-xl text-charcoal/70 leading-relaxed">
            Becoming a BHE Sponsor is an opportunity for your business to gain
            exposure within the Barton Hills community while supporting a good
            cause. Every business that contributes will have their company logo
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="mt-8 text-center text-sm text-charcoal/70">
            Barton Hills Elementary PTA is a 501(c)(3) non-profit organization.
            Tax ID: #74-6086853. Your contribution is tax-deductible.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-6 text-charcoal/70">
              Every sponsor receives a sign displayed on the school fence along Barton Hills Drive for one year.
            </p>
          </div>
          ...
          <div className="space-y-16">
            {tiers.map((tier) => (
              <div key={tier.name}>
                ...
                <p className="text-sm text-charcoal/70 mb-6 ml-14">
                  {tier.signage}
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  ...
                  {Array.from({ length: Math.min(1, Math.max(0, tier.slots - tier.sponsors.length)) }).map((_, i) => (
                    <div
                      key={`empty-${i}`}
