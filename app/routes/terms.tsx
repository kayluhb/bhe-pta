...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Terms of Use | Barton Hills Elementary PTA" },
    {
      name: "description",
      content:
        "Terms of use for the Barton Hills Elementary PTA website.",
    },
  ];
}
      ...
      <section className="bg-warm-white py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 prose prose-charcoal">
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            By accessing and using the Barton Hills Elementary PTA website
            (bheeagles.com), you agree to these Terms of Use. If you do not
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            This website is provided by the Barton Hills Elementary PTA for
            informational purposes to support our school community. You agree to
            use it only for lawful purposes related to school and PTA
            activities.
          </p>
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            The reimbursement form is provided for PTA members to submit
            expense reimbursement requests. By submitting a reimbursement
          ...
          <ul className="mt-3 space-y-2 text-charcoal/70">
            ...
            <li>
              Receipts and supporting documents are genuine and unaltered
            </li>
          </ul>
          <p className="text-charcoal/70 leading-relaxed mt-3">
            The PTA reserves the right to approve or deny any reimbursement
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            Content on this website, including text, graphics, and logos, is
            the property of the Barton Hills Elementary PTA or its content
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            ...
            Cheddar Up, Mailchimp, Austin ISD). We are not responsible for the
            content or privacy practices of those sites. Accessing third-party
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            ...
            The BHE PTA makes no guarantees about the accuracy, completeness,
            or reliability of any information on this site. Calendar events,
            newsletter content, and other information are provided for
          ...
          <p className="text-charcoal/70 leading-relaxed mt-3">
            The Barton Hills Elementary PTA and its officers, volunteers, and
            affiliates shall not be liable for any damages arising from your use
            of this website.
          </p>
