...
export default [
  ...
  route('api/admin/budgets/seed', './routes/api.admin.budgets-seed.ts'),
  route('api/admin/budgets/generate', './routes/api.admin.budgets-generate.ts'),
  route('api/admin/budgets/:id/file', './routes/api.admin.budget-file.ts'),
